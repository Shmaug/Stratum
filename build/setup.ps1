...
cmake -S "$MSDFGEN_DIR" -B . -Wno-dev -DFREETYPE_INCLUDE_DIRS="$MSDFGEN_DIR/freetype/include" -DFREETYPE_LIBRARY="$MSDFGEN_DIR/freetype/win64/freetype.lib" -DCMAKE_INSTALL_PREFIX="$MSDFGEN_DIR"
cmake --build . --config $buildType --target install
