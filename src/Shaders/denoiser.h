...
[[vk::binding( 6,0)]] RWTexture2D<float4> gAccumColor;
[[vk::binding( 7,0)]] RWTexture2D<float2> gAccumMoments;
[[vk::binding( 8,0)]] RWTexture2D<float4> gFilterImages[2];
...
[[vk::binding(14,0)]] RWTexture2D<float4> gDebugImage;
