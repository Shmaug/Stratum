...
[[vk::binding(9,1)]] StructuredBuffer<uint> gViewVolumeInstances;
[[vk::binding(10,1)]] StructuredBuffer<uint> gInstanceIndexMap;
[[vk::binding(11,1)]] RWTexture2D<float4> gAlbedo;
[[vk::binding(12,1)]] RWTexture2D<float4> gAccumColor;
[[vk::binding(13,1)]] RWTexture2D<float2> gAccumMoments;
[[vk::binding(14,1)]] RWTexture2D<uint> gGradientSamples;
[[vk::binding(15,1)]] RWTexture2D<float4> gFilterImages[2];
[[vk::binding(16,1)]] RWTexture2D<float2> gDiffImage1[2];
[[vk::binding(17,1)]] RWTexture2D<float4> gDiffImage2[2];
[[vk::binding(18,0)]] SamplerState gSampler1;

[[vk::binding(19,1)]] StructuredBuffer<ViewData> gPrevViews;
[[vk::binding(20,1)]] RWStructuredBuffer<Reservoir> gPrevReservoirs;
[[vk::binding(21,1)]] RWStructuredBuffer<VisibilityInfo> gPrevVisibility;
[[vk::binding(22,1)]] Texture2D<float4> gPrevRadiance;
[[vk::binding(23,1)]] Texture2D<float4> gPrevAlbedo;
[[vk::binding(24,1)]] Texture2D<float4> gPrevAccumColor;
[[vk::binding(25,1)]] Texture2D<float2> gPrevAccumMoments;
