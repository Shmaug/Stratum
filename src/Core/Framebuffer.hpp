...
public:
	...
	inline const TextureView& operator[](size_t index) const { return mAttachments[index]; }
	inline const TextureView& operator[](const RenderAttachmentId& id) const { return mAttachments[mRenderPass.AttachmentIndex(id)]; }
};
