...
public:
	...
	inline vk::DeviceSize device_address() const { return mDevice->getBufferAddress(vk::BufferDeviceAddressInfo(mBuffer)); }
#endif
	...
	public:
		...
		inline operator View<byte>() const { return View<byte>(mBuffer, mOffset, size_bytes()); }
