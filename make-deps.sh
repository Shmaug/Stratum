...
build_target freetype2 "Debug" "-DFT_WITH_PNG=OFF -DFT_WITH_ZLIB=OFF -DCMAKE_DISABLE_FIND_PACKAGE_ZLIB=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_BZip2=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_PNG=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_HarfBuzz=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_BrotliDec=TRUE"
build_target freetype2 "Release" "-DFT_WITH_PNG=OFF -DFT_WITH_ZLIB=OFF -DCMAKE_DISABLE_FIND_PACKAGE_ZLIB=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_BZip2=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_PNG=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_HarfBuzz=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_BrotliDec=TRUE"

build_target msdfgen $cfg "-DFREETYPE_INCLUDE_DIR_freetype2='$STRATUM_DIR/extern/include' -DFREETYPE_INCLUDE_DIR_ft2build='$STRATUM_DIR/extern/include/freetype2' -DFREETYPE_LIBRARY_DEBUG='$STRATUM_DIR/extern/lib/freetyped.lib' -DFREETYPE_LIBRARY_RELEASE='$STRATUM_DIR/extern/lib/freetype.lib' -DMSDFGEN_BUILD_MSDFGEN_STANDALONE=OFF -DFREETYPE_WITH_PNG=OFF"
